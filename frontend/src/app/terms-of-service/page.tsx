      ...
      <main className="container mx-auto px-4 sm:px-6 py-12 lg:py-16 max-w-4xl">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8 text-text-secondary">
          <section>
            ...
            <p>
              By accessing and using the MediCare platform, you agree to be bound by these Terms of
          ...
          <section>
            ...
            <p className="mb-4">
              You agree to use our telemedicine services only for lawful purposes and in accordance
              with these Terms.
            </p>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                You agree to provide accurate and complete information during registration and
                consultations.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              MediCare does not replace your primary care physician. In case of a medical emergency,
              dial 911 immediately. Our AI diagnostic tools are for informational purposes only and
              do not constitute a definitive medical diagnosis.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              The content, features, and functionality of the MediCare platform are owned by
              MediCare and are protected by international copyright, trademark, and other
          ...
          <section>
            ...
            <p>
              ...
              immediately, without prior notice or liability, for any reason, including without
              limitation if you breach the Terms.
            </p>
          </section>

          <p className="text-sm text-text-secondary pt-8">Last Updated: February 6, 2026</p>
        </div>
      </main>
      <FooterSection />
    </div>
