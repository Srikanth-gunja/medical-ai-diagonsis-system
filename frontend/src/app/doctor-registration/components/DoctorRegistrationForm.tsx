                    ...
                    <div className="p-8 text-center space-y-6">
                        <div className="bg-warning/10 border border-warning/20 rounded-xl p-6">
                            ...
                            <p className="text-text-secondary">
                                Our team will review your credentials and verify your medical license.
        ...
        <div className="w-full max-w-4xl mx-auto">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full h-12 px-4 bg-background border rounded-lg transition-base focus:outline-none focus:ring-2 ${errors.fullName
                                            ? 'border-error focus:border-error focus:ring-error/20' : 'border-input focus:border-primary focus:ring-primary/20'
                                            }`}
                                    />
                                    {errors.fullName && (
                        ...
                        <div className="pt-6 border-t border-border">
                            ...
                            <div className="bg-muted/50 border border-dashed border-border rounded-xl p-6 text-center">
                                ...
                                <p className="text-sm text-text-secondary mb-4">
                                    Document upload feature will be available soon. For now, our team will verify your credentials manually.
                                </p>
            ...
            <div className="mt-6 text-center">
                <p className="text-xs text-text-secondary">
                    Your application will be reviewed by an administrator. You will receive an email notification once your account is verified.
                </p>
            </div>
        </div>
    );
