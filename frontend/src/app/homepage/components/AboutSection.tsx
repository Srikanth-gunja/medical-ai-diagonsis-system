        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8 order-2 lg:order-1">
            ...
            <p className="text-lg text-text-secondary leading-relaxed">
              At MediCare, we bridge the gap between advanced technology and compassionate care. Our
              mission is to provide accessible, high-quality healthcare to everyone, everywhere. By
              combining AI-powered diagnostics with a network of certified medical professionals, we
