...
export default function PatientDashboardClientLayout({ children }: PatientDashboardClientLayoutProps) {
            ...
            <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/10">
                <PatientDashboardHeader
                    user={{
                        ...
                        role: 'patient',
                        avatar: user?.avatar || 'https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg'
                    }}
                    ...
                    <div className="container mx-auto px-4 sm:px-6 py-8">
                        <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
                            ...
                            <div className="flex items-center space-x-6 text-sm">
                                <a href="#privacy" className="text-text-secondary hover:text-primary transition-base">
                                    Privacy Policy
                                </a>
                                <a href="#terms" className="text-text-secondary hover:text-primary transition-base">
                                    Terms of Service
                                </a>
                                <a href="#support" className="text-text-secondary hover:text-primary transition-base">
                                    Support
                                </a>
                            </div>
                        </div>
