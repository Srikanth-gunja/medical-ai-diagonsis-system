                        ...
                        <div className="flex items-center space-x-1">
                            {[1, 2, 3, 4, 5].map((rating) => (
                                <button
                                    ...
                                    className={`p-1.5 rounded-lg transition-base ${filters.minRating >= rating
                                        ? 'text-warning' : 'text-muted-foreground hover:text-warning'
                                        }`}
                                    aria-label={`${rating} stars`}
                                >
                                    <Icon name="StarIcon" variant={filters.minRating >= rating ? 'solid' : 'outline'} size={20} />
                                </button>
                            ))}
                        </div>
                    </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {['all', 'video', 'in-person'].map((type) => (
                                <button
                                    ...
                                    className={`px-3 py-2 rounded-lg text-xs font-medium transition-base whitespace-nowrap ${filters.consultationType === type
