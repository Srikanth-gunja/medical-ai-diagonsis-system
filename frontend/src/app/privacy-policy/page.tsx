      ...
      <main className="container mx-auto px-4 sm:px-6 py-12 lg:py-16 max-w-4xl">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8 text-text-secondary">
          <section>
            ...
            <p>
              At MediCare, we take your privacy seriously. This Privacy Policy explains how we
              collect, use, disclose, and safeguard your information when you access our
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                Personal identification information (Name, email address, phone number, date of
                birth)
              </li>
          ...
          <section>
            ...
            <p>
              ...
              server infrastructure, to protect your personal and medical information. However, no
              method of transmission over the internet requires 100% security.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:privacy@medicare.com" className="text-primary hover:underline">
