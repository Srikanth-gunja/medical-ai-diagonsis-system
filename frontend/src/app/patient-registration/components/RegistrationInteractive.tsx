                ...
                <div className="glassmorphism rounded-2xl shadow-elevation-3 overflow-hidden">
                    <div className="p-6 sm:p-8 lg:p-12">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            {currentStep === 2 && (
                                <ContactDetailsSection formData={formData} errors={errors} onChange={handleChange} />
                            )}

                            {currentStep === 3 && <MedicalHistorySection formData={formData} onChange={handleChange} />}
