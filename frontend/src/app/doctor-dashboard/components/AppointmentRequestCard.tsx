...
export default function AppointmentRequestCard({
  ...
  return (
    <div className="group relative bg-card border border-border rounded-2xl p-5 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col gap-4">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-12 h-12 rounded-full overflow-hidden bg-muted ring-4 ring-muted/50 group-hover:ring-primary/10 flex-shrink-0 transition-all">
              <AppImage
        ...
        <div className="bg-muted rounded-xl p-4 border border-border/50">
          <div className="flex items-center gap-2 text-foreground/80 font-semibold text-sm mb-1.5 leading-tight">
            <div className="p-1 rounded bg-card shadow-sm text-primary">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-success text-success-foreground rounded-xl hover:bg-success/90 hover:shadow-md hover:shadow-success/20 active:scale-[0.98] transition-all text-sm font-semibold"
          >
          ...
          <button
            ...
            className="flex flex-1 items-center justify-center gap-2 px-4 py-2.5 bg-card text-foreground/80 border border-border shadow-sm rounded-xl hover:bg-rose-50 hover:text-rose-700 hover:border-rose-300 dark:hover:bg-rose-950/30 dark:hover:text-rose-400 dark:hover:border-rose-800 active:scale-[0.98] transition-all text-sm font-semibold"
          >
