    ...
    const fetchAppointments = async () => {
        try {
            ...
            if (patientAppointments.length > 0) {
                ...
                setCanChat(false);
                setError('No active appointments with this patient. Chat is available during confirmed appointments.');
            }
            setIsLoading(false);
        } catch (err) {
                ...
                <div className="relative bg-gradient-to-br from-primary via-primary/90 to-accent p-6 pb-4">
                    ...
                    <div className="relative flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <div className="relative">
                                ...
                                <div className={`absolute bottom-0 right-0 w-4 h-4 rounded-full border-2 border-white ${canChat ? 'bg-success animate-pulse' : 'bg-gray-400'}`} />
                            </div>
                            <div>
                    ...
                    {appointments.length > 1 && (
                        <div className="relative mt-4">
                            ...
                            <Icon name="ChevronDownIcon" size={16} className="absolute right-3 top-1/2 -translate-y-1/2 text-white/70 pointer-events-none" />
                        </div>
                    )}
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3 h-[calc(100vh-220px)] bg-gradient-to-b from-muted/30 to-background/50">
                    {isLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center py-8 px-4">
                            ...
                            <h3 className="text-lg font-semibold text-text-primary mb-2">No Active Appointment</h3>
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center py-8">
                            ...
                            <h3 className="text-lg font-semibold text-text-primary mb-2">Start the Conversation</h3>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className={`flex items-center justify-end gap-1 mt-1.5 ${isMe ? 'text-white/60' : 'text-text-tertiary'}`}>
