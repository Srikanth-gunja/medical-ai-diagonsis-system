...
const AuthenticatedHeader = ({
    ...
    const patientNavItems = [
        ...
        { label: 'Medical History', path: '/patient-dashboard/medical-history', icon: 'DocumentTextIcon' },
    ...
    return (
        <header className={`sticky top-0 z-40 bg-card border-b border-border shadow-elevation-1 ${className}`}>
            <div className="container mx-auto px-4 sm:px-6">
                <div className="flex items-center justify-between h-16">
                    <div className="flex items-center space-x-8">
                        <Link href={user.role === 'patient' ? '/patient-dashboard' : '/doctor-dashboard'} className="flex items-center space-x-2 hover:opacity-80 transition-base">
                                    ...
                                    <div className="max-h-96 overflow-y-auto">
                                        {isLoadingNotifications ? (
                                            ...
                                            <div className="py-12 text-center">
                                                <Icon name="BellSlashIcon" size={40} className="mx-auto text-text-tertiary mb-3" />
                                                <p className="text-text-secondary text-sm">No notifications yet</p>
                                                <p className="text-text-tertiary text-xs mt-1">We'll notify you when something arrives</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                        ...
                        <div className="relative hidden sm:block">
                            ...
                            {isProfileMenuOpen && (
                                <div className="absolute right-0 mt-2 w-56 bg-card border border-border rounded-lg shadow-elevation-3 animate-fade-in overflow-hidden">
                                    ...
                                    <div className="py-2">
                                        <Link
                                            href={user.role === 'patient' ? '/patient-dashboard/profile' : '/doctor-dashboard/profile'}
